...
2. If the code is **rejected**, you will be re-assigned to the ticket by the `project-orchestrator` and expected to resolve the issues documented a comment by the `code-reviewer`.
